                ...
                Parallel.For(0, iterations, i =>
                {
                    ...
                    if (_frequency_stage.CurveMetaData.IsNull)
                    {
                        ...
                        if (_frequency_discharge_graphical.CurveMetaData.IsNull)
                        {
                            ...
                            frequencyDischarge = _frequency_discharge.BootstrapToPairedData(threadlocalRandomProvider, LogPearson3._RequiredExceedanceProbabilitiesForBootstrapping);//ordinates defines the number of values in the frequency curve, more would be a better approximation.
        ...
        private Threshold ComputeDefaultThreshold(ConvergenceCriteria convergenceCriteria, bool computeWithDamage, bool computeIsDeterministic)
        {
            ...
            if (_systemResponseFunction_stage_failureProbability.CurveMetaData.IsNull)
            {
                ...
                if (_frequency_stage.CurveMetaData.IsNull)
                {
                    ...
                    if (_frequency_discharge_graphical.CurveMetaData.IsNull)
                    {
                        frequencyFlow = _frequency_discharge.BootstrapToPairedData(meanRandomProvider, LogPearson3._RequiredExceedanceProbabilitiesForBootstrapping);
                    }
                    else
                    {
