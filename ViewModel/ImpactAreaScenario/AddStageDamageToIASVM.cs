...
namespace ViewModel.ImpactAreaScenario
{
    ...
    public class AddStageDamageToIASVM:BaseViewModel,Plots.iIASImporter
    {
        #region Notes
        // Created By: q0heccdm
        ...
        #endregion
        #region Constructors
        public AddStageDamageToIASVM(List<AggregatedStageDamage.AggregatedStageDamageElement> listOfStageDamageElements ):this(listOfStageDamageElements,null)
        {

        }
        public AddStageDamageToIASVM(List<AggregatedStageDamage.AggregatedStageDamageElement> listOfStageDamageElements, AggregatedStageDamage.AggregatedStageDamageElement selectedElement ):base()
        {
