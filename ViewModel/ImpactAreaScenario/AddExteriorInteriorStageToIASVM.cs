...
namespace ViewModel.ImpactAreaScenario
{
    ...
    public class AddExteriorInteriorStageToIASVM : BaseViewModel, Plots.iIASImporter
    {
        #region Notes
        // Created By: q0heccdm
        ...
        private List<ExteriorInteriorElement> _ListOfExteriorInteriorStageElements;
        ...
        public List<ExteriorInteriorElement> ListOfExteriorInteriorStageElements
        {
        ...
        #endregion
        #region Constructors
        public AddExteriorInteriorStageToIASVM(List<ExteriorInteriorElement> listOfExIntStage) : this(listOfExIntStage, null)
        {

        }
        public AddExteriorInteriorStageToIASVM(List<ExteriorInteriorElement> listOfExIntStage, ExteriorInteriorElement selectedElement) : base()
        {
        ...
        public void OKClicked()
        {
            ...
            if (!HasFatalError)
            {
                OKClickedEvent?.Invoke(this, new EventArgs());
            }
            else
            {
        ...
        public void CancelClicked()
        {
            ...
            {
                CancelClickedEvent(this, new EventArgs());
            }
        }
