...
namespace ViewModel.ImpactAreaScenario
{
    ...
    public class AddFlowFrequencyToIASVM:BaseViewModel,Plots.iIASImporter
    {
        #region Notes
        // Created By: q0heccdm
       ...
       // private ParentElement _owner;
        ...
        //}
        public AddFlowFrequencyToIASVM(List<FrequencyRelationships.AnalyticalFrequencyElement> lp3Curves):this(lp3Curves,null)
        {

        }
        public AddFlowFrequencyToIASVM(List<FrequencyRelationships.AnalyticalFrequencyElement> lp3Curves, FrequencyRelationships.AnalyticalFrequencyElement selectedElement) : base()
        {
