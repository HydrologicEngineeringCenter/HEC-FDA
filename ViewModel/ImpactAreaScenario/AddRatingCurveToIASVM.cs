...
namespace ViewModel.ImpactAreaScenario
{
    ...
    public class AddRatingCurveToIASVM : Editors.BaseEditorVM,Plots.iIASImporter
    {
        #region Notes
        // Created By: q0heccdm
        ...
        #endregion
        #region Constructors
        public AddRatingCurveToIASVM(List<StageTransforms.RatingCurveElement> listOfRatingCurves ):base(null)
        {
        ...
        public AddRatingCurveToIASVM(List<StageTransforms.RatingCurveElement> listOfRatingCurves, StageTransforms.RatingCurveElement selectedRatingElement ):base(selectedRatingElement,null)
        {
