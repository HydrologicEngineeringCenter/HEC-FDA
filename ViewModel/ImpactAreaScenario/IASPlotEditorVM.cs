...
namespace ViewModel.ImpactAreaScenario
{
    ...
    public class IASPlotEditorVM : CurveEditorVM
    {
        #region Notes
        // Created By: q0heccdm
        ...
        public IASPlotEditorVM(List<ImpactAreaElement> impAreas, IndividualLinkedPlotControlVM indLinkedPlotControl0VM, IndividualLinkedPlotControlVM control1VM,
        ...
        public IASPlotEditorVM(List<ImpactAreaElement> impAreas, IndividualLinkedPlotControlVM defaultControl0VM, IndividualLinkedPlotControlVM defaultControl1VM, 
        ...
        private void UpdatePreviewComputePlot(object sender, EventArgs e)
        {
            ...
            bool hasPlot3 = false;
            bool hasPlot7 = false;
            if(Plot0ControlVM.CurrentVM.GetType() == typeof(Plots.IASIndividualPlotWrapperVM))
            {
                hasPlot0 = true;
            }
            if (Plot3ControlVM.CurrentVM.GetType() == typeof(Plots.IASIndividualPlotWrapperVM))
            {
                hasPlot3 = true;
            }
            if (Plot7ControlVM.CurrentVM.GetType() == typeof(Plots.IASIndividualPlotWrapperVM))
            {
                hasPlot7 = true;
            }
