...
namespace ViewModel.ImpactAreaScenario
{
    ...
    public class AddInflowOutflowToIASVM:BaseViewModel,Plots.iIASImporter
    {
        #region Notes
        // Created By: q0heccdm
        ...
        #endregion
        #region Constructors
        public AddInflowOutflowToIASVM(List<FlowTransforms.InflowOutflowElement> listOfinOut ):this(listOfinOut,null)
        {

        }

        public AddInflowOutflowToIASVM(List<FlowTransforms.InflowOutflowElement> listOfinOut, FlowTransforms.InflowOutflowElement selectedElement ):base()
        {
