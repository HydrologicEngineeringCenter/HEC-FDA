...
namespace ViewModel.Plots
{
    ...
    public class IASIndividualPlotWrapperVM : BaseViewModel, IIndividualLinkedPlotWrapper
    {
        #region Notes
        // Created By: q0heccdm
        ...
        #endregion
        #region Constructors
        public IASIndividualPlotWrapperVM():base()
        {

        }
        
        public IASIndividualPlotWrapperVM(bool isXAxisLog, bool isYAxisLog, bool isProbabilityXAxis, bool isProbabilityYAxis, bool xAxisOnBottom, bool yAxisOnLeft)
        {
