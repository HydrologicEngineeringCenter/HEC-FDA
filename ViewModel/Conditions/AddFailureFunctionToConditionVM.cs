...
{
    public class AddFailureFunctionToConditionVM : BaseViewModel, Plots.iConditionsImporter
    {
        #region Notes
        // Created By: q0heccdm
        ...
        #endregion
        #region Constructors
        public AddFailureFunctionToConditionVM(List<LeveeFeatureElement> listOfLeveeFeatures) : this(listOfLeveeFeatures, null)
        {

        }
        public AddFailureFunctionToConditionVM(List<LeveeFeatureElement> listOfLeveeFeatures, LeveeFeatureElement selectedElement) : base()
        {
