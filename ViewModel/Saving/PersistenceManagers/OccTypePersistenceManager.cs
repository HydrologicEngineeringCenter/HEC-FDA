...
namespace ViewModel.Saving.PersistenceManagers
{
    public class OccTypePersistenceManager : SavingBase, IElementManager
    {
        ...
        public IOccupancyType GetFDA2OccupancyType(Importer.OccupancyType ot1)
        {
            ...
            List<ICoordinatesFunction> coordFunctions = TranslateSingleDamageFunctionToCoordinatesFunctions(ot1._SingleDamageFunction, errorMessages);
