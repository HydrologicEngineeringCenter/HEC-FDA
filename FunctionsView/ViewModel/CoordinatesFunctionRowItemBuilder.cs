...
namespace FunctionsView.ViewModel
{
    public class CoordinatesFunctionRowItemBuilder
    {
        ...
        //    return this;
        //}
        public CoordinatesFunctionRowItemBuilder WithNormalDist(double mean, double standardDeviation)
        {
        ...
        public CoordinatesFunctionRowItemBuilder WithConstantDist(double y)
        {
            _Y = y;
        ...
        {
            return new CoordinatesFunctionRowItem(_X, _Y, _standDev, _mean, _min, _max, _mostLikely,_alpha, _beta, _distType, _isReadOnly);
        }
    }
}
