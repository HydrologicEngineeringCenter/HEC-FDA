...
namespace fda_model_test.unittests
{
    ...
    public class AlternativeComparisonReportTest
    {
        ...
        public void ComputeAAEQDamage(double expected, int poa, double discountRate, int baseYear, int futureYear, int iterations, double topOfLeveeElevation)
        {
            ...
            double actual = alternativeComparisonReportResults.GetAlternativeResults(identifier).GetDamageResults(identifier).ConsequenceExceededWithProbabilityQ(damCat, mrp.NextRandom(), assetCategory, identifier);
