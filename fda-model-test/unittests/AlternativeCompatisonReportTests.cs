...
namespace fda_model_test.unittests
{
    ...
    public class AlternativeComparisonReportTest
    {
        ...
        [Theory]
        [InlineData(50, .0275, 2023, 2072, 1, 75000)]
        [InlineData(50, .0275, 2023, 2050, 1, 75000)]
        public void AlternativeResultsReadTheSameTHingItWrites(int poa, double discountRate, int baseYear, int futureYear, int iterations, double topOfLeveeElevation)
        {
            double[] FlowXs = { 0, 100000 };
            double[] StageXs = { 0, 150000 };
            string xLabel = "x label";
            ...
            AlternativeComparisonReportResults alternativeComparisonReportResults = AlternativeComparisonReport.ComputeDistributionOfAAEQDamageReduced(mrp, convergenceCriteria, withoutProjectAlternativeResults, withProjectAlternativeResultsList);
            XElement alternativeComparisonResultsToXML = alternativeComparisonReportResults.WriteToXML();
            AlternativeComparisonReportResults alternativeComparisonReportResultsFromXML = AlternativeComparisonReportResults.ReadFromXML(alternativeComparisonResultsToXML);
            bool testPasses = alternativeComparisonReportResults.Equals(alternativeComparisonReportResultsFromXML);
