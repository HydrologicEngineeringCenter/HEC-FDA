...
namespace fda_model_test.unittests
{
    ...
    public class AlternativeComparisonReportTest
    {
        ...
        //    }
        //    IDistribution[] futureDamagesModified = new IDistribution[2];
        //    for (int i = 0; i < 2; i++)
        //    {
        //        futureDamagesModified[i] = new Uniform(0, futureYearDamage*i, 10);
        //    }
