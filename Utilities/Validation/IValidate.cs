...
{
    /// <summary>
    /// Provides an interface for data objects which are validated by <see cref="IValidator{T}"/> objects. Follows a vistor pattern.
    /// </summary>
    /// <typeparam name="T"> The type of the object being validated. </typeparam>
    public interface IValidate<T>: IMessagePublisher
    {
        /// <summary>
        /// True if the object is an validate state, false if errors exist that will prevent computation.
        /// </summary>
        bool IsValid { get; }
        //Inherits a IEnumerable<IMessage> Messages { get; } property from IMessagePublisher
        /// <summary>
