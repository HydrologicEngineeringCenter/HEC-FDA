...
{
    internal class LinkedCoordinatesFunctionValidator : IValidator<LinkedCoordinatesFunction>
    {
        public bool IsValid(LinkedCoordinatesFunction entity, out IEnumerable<string> errors)
        {
            errors = ReportErrors(entity);
            return !errors.Any();
        }

        public IEnumerable<string> ReportErrors(LinkedCoordinatesFunction entity)
        {
