...
{
    internal class CoordinatesFunctionLinkedOrdinates : CoordinatesFunctionLinkedBase, ICoordinatesFunction, IValidate<CoordinatesFunctionLinkedOrdinates>
    {
        ...
        internal CoordinatesFunctionLinkedOrdinates(List<ICoordinatesFunction> functions, List<InterpolationEnum> interpolators)
        {
