...
using Ordinates;
using Functions;
using Functions.OrdinatesFunctions;
...
namespace DbMemory
{
    ...
    public class SingleDamageFunction 
    {
        ...
        //Problem when trying to serialize a null IFunction, had to modify Johns code
        private IFunction<double> _theFunction;
        ...
        //{ return this._ErrHi; }
        public IFunction<double> getFunctionV2()
        {
            return _theFunction;
        }
        public IFunction<double> ConvertToV2()
        {
