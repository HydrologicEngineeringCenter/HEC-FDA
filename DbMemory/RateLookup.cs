...
{
    [Serializable]
    public class RateLookup : DbfFileFdLookupManager
    {
        public RateLookup() : base()
        {
            ;
        }
        public void Print()
        {
            ...
            Write($"\tRating Function ID: {_IdDataFunc}");
            Write("\n");
        }
        public void PrintToFile()
        {
            ...
            wr.WriteLine($"\tRating Function Name: {GlobalVariables.mp_fdaStudy.GetRatingFunctionList().GetName(_IdDataFunc)}");
        }
