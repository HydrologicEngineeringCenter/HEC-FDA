...
{
    //internal class SummaryStatistics : ISampleStatistics
    //{
    ...
    //    }       
    //    public IMessageLevels Validate(IValidator<ISampleStatistics> validator, out IEnumerable<IMessage> errors)
    //    {
