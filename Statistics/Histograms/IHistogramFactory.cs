...
namespace Statistics
{
    ...
    public static class IHistogramFactory
    {
        ...
        /// <returns> A new object implementing the <see cref="IHistogram"/> interface filled with the provided <paramref name="data"/>. </returns>
        public static IHistogram Factory(IData data, int nBins) => data.IsNull() ? throw new ArgumentNullException(nameof(data)) : HistogramValidator.IsConstructable(data.Range.Min, data.Range.Max, nBins, out IList<string> errors) ? Factory(data, data.Range.Min, data.Range.Max, (data.Range.Max - data.Range.Min) / (double)nBins) : throw new InvalidConstructorArgumentsException(errors);
        /// <summary>
