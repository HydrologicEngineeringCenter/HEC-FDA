...
namespace Statistics.Validation
{
    class SummaryStatisticsValidator: IValidator<ISampleStatistics>
    {
        ...
        public IEnumerable<IMessage> ReportErrors(ISampleStatistics obj)
        {
            ...
            if (obj.SampleSize == 2) messages.Add(IMessageFactory.Factory(IMessageLevels.Message, $"The sample contains {obj.SampleSize} item(s) and therefore does not have the degrees of freedom required to compute sample {nameof(obj.Skewness)} and this parameter has been set to 0."));
            return messages;
        }
