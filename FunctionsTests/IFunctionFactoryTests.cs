...
namespace FunctionsTests
{
    public class IFunctionFactoryTests
    {
        ...
        //        List<ICoordinate<IOrdinate, IOrdinate>> list = new List<ICoordinate<IOrdinate, IOrdinate>>(coordinate);
        ...
        //    {
        //        ICoordinate<IOrdinate, IOrdinate> coordinate = ICoordinateFactory.Factory(IScalarFactory.Factory(0), IScalarFactory.Factory(0));
        //        List<ICoordinate<IOrdinate, IOrdinate>> list = ImmutableList<ICoordinate<IOrdinate, IOrdinate>>.Empty;
        //        IFunction testObj = IFunctionFactory.Factory(list, InterpolationEnum.NoInterpolation);
        //        Assert.True(false);
        //    }
