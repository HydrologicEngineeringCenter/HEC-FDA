            ...
            for (int irec = 0; irec < dataTable.Rows.Count; irec++)
            {
                ...
                for (int ifield = 0; ifield < dataTable.Columns.Count; ifield++)
                {
                    ...
                    else if (colName == "FL_FFDIST")
                    {
                        ErrorType errType = ErrorType.NONE;
                        errType = (ErrorType)((int)dataTable.Rows[irec][ifield]);
                        theFunc._ErrorDistribution[0].ErrorType = (errType);
                    }
                    else if (colName == "SD_EL_FF" && theFunc._ErrorDistribution[0].ErrorType == ErrorType.NORMAL)
                        theFunc._ErrorDistribution[0].StandardDeviationOrMin = ((double)dataTable.Rows[irec][ifield]);
                        ...
                        theFunc._ErrorDistribution[0].Maximum = ((double)dataTable.Rows[irec][ifield]);
                    ...
                    else if (colName == "FL_SVALDIS")
                    {
                        ErrorType errType = ErrorType.NONE;
                        errType = (ErrorType)((int)dataTable.Rows[irec][ifield]);
                        theFunc._ErrorDistribution[1].ErrorType = (errType);
                    }
                    else if (colName == "SD_SVAL" && theFunc._ErrorDistribution[1].ErrorType == ErrorType.NORMAL)
                        theFunc._ErrorDistribution[1].StandardDeviationOrMin = ((double)dataTable.Rows[irec][ifield]);
                        ...
                        theFunc._ErrorDistribution[1].Maximum = ((double)dataTable.Rows[irec][ifield]);
                    ...
                    else if (colName == "FL_CVALDIS")
                    {
                        ErrorType errType = ErrorType.NONE;
                        errType = (ErrorType)((int)dataTable.Rows[irec][ifield]);
                        theFunc._ErrorDistribution[2].ErrorType = (errType);
                    }
                    else if (colName == "SD_CVAL" && theFunc._ErrorDistribution[2].ErrorType == ErrorType.NORMAL)
                        theFunc._ErrorDistribution[2].StandardDeviationOrMin = ((double)dataTable.Rows[irec][ifield]);
                        ...
                        theFunc._ErrorDistribution[2].Maximum = ((double)dataTable.Rows[irec][ifield]);
                    ...
                    else if (colName == "FL_OVALDIS")
                    {
                        ErrorType errType = ErrorType.NONE;
                        errType = (ErrorType)((int)dataTable.Rows[irec][ifield]);
                        theFunc._ErrorDistribution[3].ErrorType = (errType);
                    }
                    else if (colName == "SD_OVAL" && theFunc._ErrorDistribution[3].ErrorType == ErrorType.NORMAL)
                        theFunc._ErrorDistribution[3].StandardDeviationOrMin = ((double)dataTable.Rows[irec][ifield]);
                        ...
                        theFunc._ErrorDistribution[3].Maximum = ((double)dataTable.Rows[irec][ifield]);
                    ...
                    else if (colName == "FL_CRVDIS")
                    {
                        ErrorType errType = ErrorType.NONE;
                        errType = (ErrorType)((int)dataTable.Rows[irec][ifield]);
                        theFunc._ErrorDistribution[4].ErrorType = (errType);
                    }
                    else if (colName == "SD_CRVAL" && theFunc._ErrorDistribution[4].ErrorType == ErrorType.NORMAL)
                        theFunc._ErrorDistribution[4].StandardDeviationOrMin = ((double)dataTable.Rows[irec][ifield]);
                        ...
                        theFunc._ErrorDistribution[4].Maximum = ((double)dataTable.Rows[irec][ifield]);
