...
namespace Importer
{
    ...
    public class OccupancyType : FdObjectData
    {
        ...
        public bool IsEqualTo(OccupancyType other)
        {
            if (other == null)
            {
                return false;
            ...
            if (UsesDollar != other.UsesDollar)
            {
                return false;
            }

            if (RatioContent != other.RatioContent)
            {
                return false;
            }

            if (RatioOther != other.RatioOther)
            {
                return false;
            }

            if (RatioCar != other.RatioCar)
            {
                return false;
            }

            if (_ErrorDistribution.Length != other._ErrorDistribution.Length)
            {
                return false;
            }

            for (int i = 0; i < _ErrorDistribution.Length; i++)
            {
                if (!_ErrorDistribution[i].IsEqualTo(other._ErrorDistribution[i]))
                {
                    return false;
                }
            }

            if (_SingleDamageFunction.Length != other._SingleDamageFunction.Length)
            {
                return false;
            }
            ...
            {
                if (!_SingleDamageFunction[i].IsEqualTo(other._SingleDamageFunction[i]))
                {
                    return false;
                }
            }
