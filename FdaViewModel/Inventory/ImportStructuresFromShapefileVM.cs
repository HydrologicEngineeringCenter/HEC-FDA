...
namespace FdaViewModel.Inventory
{
   ...
   public  class ImportStructuresFromShapefileVM:BaseViewModel
    {
        #region Notes
        // Created By: q0heccdm
        ...
        public ImportStructuresFromShapefileVM(string name, string description,string path, DefineSIAttributesVM defineSIAttributesVM, AttributeLinkingListVM attributeLinkingListVM): base()
        ...
        public bool NextButtonClicked()
        {
            ...
            if(CurrentView.GetType() == typeof(DefineSIAttributesVM))
            {
                ...
                {
                    _AttributeLinkingList = new AttributeLinkingListVM(occtypes,OccupancyTypes.OccupancyTypesOwnerElement.ListOfOccupancyTypesGroups, _AttributeLinkingList.OccupancyTypesInStudy);
                }
            ...
            else if(CurrentView.GetType() == typeof(AttributeLinkingListVM))
            {
                ...
                //then we are done. We need to do some verification and write the data to the sqlite file
               ...
               // DataBase_Reader.SqLiteReader.CreateSqLiteFile(System.IO.Path.GetDirectoryName(SelectedPath) + "\\codyTest.sqlite");
                ...
                if(aTable.ParentDatabase.DataBaseOpen == false)
                {
                    aTable.ParentDatabase.Open();
                }
                ...
                for (int i = 0; i < aTable.NumberOfRows; i++)
                {
                    ...
                    {
                        //string groupName = "";
                        string occTypeKey = aTable.GetCell(_DefineSIAttributes.OccupancyTypeColumnName, i).ToString(); // this is the old occtype from the dbf of the struc inv.
                    ...
                    if(_DefineSIAttributes.FirstFloorElevationIsChecked == true)
                    {
                        ...
                        {
                            nextRow[StructureInventoryBaseElement.FirstFloorElevationField] = aTable.GetCell(_DefineSIAttributes.FirstFloorElevationColumnName, i);
                        }
                        else
                        {
                    ...
                    else
                    {
                        ...
                        {
                            nextRow[StructureInventoryBaseElement.FoundationHeightField] = aTable.GetCell(_DefineSIAttributes.FoundationHeightColumnName, i);
                        }
                        else
                        {
                        ...
                        {
                            nextRow[StructureInventoryBaseElement.GroundElevationField] = aTable.GetCell(_DefineSIAttributes.GroundElevationColumnName, i);
                        }
                        else
                        {
                    ...
                    {
                        nextRow[StructureInventoryBaseElement.StructureValueField] = aTable.GetCell(_DefineSIAttributes.StructureValueColumnName, i);
                    }
                    else
                    {
                    ...
                    if (_DefineSIAttributes.ContentValueIsUsingDefault == false)
                    {
                        ...
                        {
                            nextRow[StructureInventoryBaseElement.ContentValueField] = aTable.GetCell(_DefineSIAttributes.ContentValueColumnName, i);
                        }
                        else
                        {
                    ...
                    if (_DefineSIAttributes.OtherValueIsUsingDefault == false)
                    {
                        ...
                        {
                        nextRow[StructureInventoryBaseElement.OtherValueField] = aTable.GetCell(_DefineSIAttributes.OtherValueColumnName, i);
                    ...
                    if (_DefineSIAttributes.VehicleValueIsUsingDefault == false)
                    {
                        ...
                        {
                        nextRow[StructureInventoryBaseElement.VehicleValueField] = aTable.GetCell(_DefineSIAttributes.VehicleValueColumnName, i);
                    ...
                    if (_DefineSIAttributes.YearIsUsingDefault == false)
                    {
                        ...
                        {
                            nextRow[StructureInventoryBaseElement.YearField] = aTable.GetCell(_DefineSIAttributes.YearColumnName, i);
                    ...
                    if (_DefineSIAttributes.ModuleIsUsingDefault == false)
                    {
                        ...
                        {
                            nextRow[StructureInventoryBaseElement.ModuleField] = aTable.GetCell(_DefineSIAttributes.ModuleColumnName, i);
