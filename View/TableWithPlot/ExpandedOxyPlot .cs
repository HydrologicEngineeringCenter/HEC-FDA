...
namespace HEC.FDA.View.TableWithPlot
{
    public class ExpandedOxyPlot : OxyPlot.Wpf.PlotView
    {
        ...
        public ExpandedOxyPlot() : base()
        {
            ...
            Image selectIcon = new Image() { Source = new BitmapImage(new Uri("pack://application:,,,/Icons/TrackPlot.png")) };
            ...
            // 
            Image panIcon = new Image() { Source = new BitmapImage(new Uri("pack://application:,,,/Icons/PanHand.png")) };
            ...
            // 
            Image zoomIcon = new Image() { Source = new BitmapImage(new Uri("pack://application:,,,/Icons/ZoomIn.png")) };
            ...
            // 
            Image zoomAllIcon = new Image() { Source = new BitmapImage(new Uri("pack://application:,,,/Icons/ZoomAll.png")) };
