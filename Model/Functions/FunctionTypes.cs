...
namespace FdaModel.Functions
{
    public enum FunctionTypes
    {
        ...
        */
        ...
        InteriorStageFrequency = 6,     //AnnualExceedanceChance-> PeakInteriorStage
        InteriorStageDamage = 7,        //InteriorPeakStage     -> AggregatedDamage
        DamageFrequency = 8,            //AnnualExceedanceChance-> AggregatedDamage 
        LeveeFailure = 9,               //Stage                 -> ChanceOfFailure
