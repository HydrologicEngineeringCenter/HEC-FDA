...
namespace Model
{
    ...
    public static class ITransformFunctionFactory
    {
        ...
        public static ITransformFunction Factory(IFunction fx, IParameterEnum fType, UnitsEnum xUnits = UnitsEnum.NotSet, string xLabel = "", UnitsEnum yUnits = UnitsEnum.NotSet, string yLabel = "")
        {
            switch (fType)
            {
                case IParameterEnum.InflowOutflow:
                    ...
                    return new Functions.InflowOutflow(fx, xUnits, xLabel, yUnits, yLabel);
                case IParameterEnum.Rating:
                    ...
                    return new Functions.Rating(fx, xUnits, xLabel, yUnits, yLabel);
                case IParameterEnum.ExteriorInteriorStage:
                    ...
                    return new Functions.ExteriorInteriorStage(fx, xUnits, xLabel, yUnits, yLabel);
                case IParameterEnum.InteriorStageDamage:
                    ...
                    return new Functions.StageDamage(fx, xUnits, xLabel, yUnits, yLabel);
                default:
