...
{
    public interface IFrequencyFunction<YType>:IFdaFunction<YType>
    {
        ...
        //IComputableFrequencyFunction Compose(ITransformFunction transformFunction, double frequencyFunctionProbability = 0.50, double transformFunctionProbability = 0.50);
        //IFunctionCompose Compose(IFunctionTransform transformFunction); --> Need to Implement this...
        //double Integrate();
        ImpactAreaFunctionEnum Type { get; }

       // IComputableFrequencyFunction Sample(double p);
