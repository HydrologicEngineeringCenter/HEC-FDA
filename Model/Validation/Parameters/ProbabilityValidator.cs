...
namespace Model.Validation
{
    internal class ProbabilityValidator : IValidator<Probability>
    {
        ...
        public IEnumerable<IMessage> ReportErrors(Probability obj)
        {
            ...
            {
                if (!obj.ParameterType.IsProbability()) msgs.Add(IMessageFactory.Factory(IMessageLevels.Error, $"A probability parameter was expected but a {obj.ParameterType.Print()} parameter was found causing an error."));
