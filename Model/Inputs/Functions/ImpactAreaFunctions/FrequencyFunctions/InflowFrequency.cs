...
{
    internal sealed class InflowFrequency : ImpactAreaFunctionBase, IFrequencyFunction
    {
        #region Properties
        public override string XLabel => "Frequency";

        public override string YLabel => "Inflow";
        public List<ImpactAreaFunctionEnum> ComposeableTypes => new List<ImpactAreaFunctionEnum>() { ImpactAreaFunctionEnum.InflowOutflow, ImpactAreaFunctionEnum.Rating };
