...
//    }
    ...
    //        TransformFunctions = transformFunctions.OrderBy(i => i.ParameterType).ToList();
    ...
    //            while (frequencyFunction.ParameterType == Metrics[j].TargetFunction)
    //            {
    ...
    //    //    }
    //    //}        
    //    //private void ApproximateMetricRange(IDictionary<IMetricEnum, double> result, bool firstPass)
    //    //{
    //    //    if (firstPass == false)
    //    //    {
    ...
    //    //    return P;
    //    //}
    //    //public IDictionary<IMetricEnum, double> ComputeRealization(int seed, bool testCompute = false)
    //    //{
    //    //    int j = 0, J = ComputePoints.Count, n = 0;
    //    //    IFunctionCompose frequencyFunction = EntryPoint;
    //    //    IDictionary<IMetricEnum, double> metrics = new Dictionary<IMetricEnum, double>();
    ...
    //    //        {
    //    //            if (ComputePoints[j].Unit < IMetricEnum.ExpectedAnnualDamage)
    ...
    //    //public IDictionary<IMetricEnum, double> Compute(int seed)
    //    //{
    ...
    //    //}
    //    //private IDictionary<IMetricEnum, double> InnerCompute(double[] P)
    //    //{
    //    //    int j = 0, J = ComputePoints.Count, n = 0;
    //    //    IDictionary<IMetricEnum, double> metrics = new Dictionary<IMetricEnum, double>();
    //    //    for (int i = 0; i < TransformFunctions.Count; i++)
    ...
    //    //{
    //    //    if (ComputePoints[computePoint].Unit == IMetricEnum.ExpectedAnnualDamage)
    ...
    //    {
    //        TransformFunctions.OrderBy(t => t.ParameterType);
    //        if (Metrics.Count == 0) return false;
    //        Metrics.OrderBy(t => t.Type);
    //        foreach (ITransformFunction tFunction in TransformFunctions)
    //        {
    //            if (tFunction.ParameterType < EntryPoint.ParameterType ||
    //                tFunction.ParameterType > Metrics[Metrics.Count - 1].TargetFunction) return false;
    //        }
    //        foreach (IMetric metric in Metrics)
    //        {
    //            IParameterEnum exit = metric.TargetFunction;
    //            if (exit < EntryPoint.ParameterType ||
    //                exit > TransformFunctions[TransformFunctions.Count - 1].ParameterType + 1) return false;
    //        }
    //        return true;
    //    }
    ...
    //        {
    //            if (function.ParameterType < EntryPoint.ParameterType &&
    //                function.ParameterType > Metrics[Metrics.Count - 1].TargetFunction)
    //            {
    //                TransformFunctions.Remove(function);
    //                transformFunctionMessages.AppendLine("A ")
    //                                         .Append(function.ParameterType)
