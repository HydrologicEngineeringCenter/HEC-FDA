...
namespace Model
{
    ...
    public interface IConditionLocationTimeSummary
    {
        ...
        /// </summary>
        /// <param name="sampleParameters"> A dictionary of parameter <see cref="IParameterEnum"/> key and sample probability <see cref="ISample"/> value pairs. <seealso cref="IConditionLocationTimeSummary.SampleParametersPacket(Random, IReadOnlyDictionary{IParameterEnum, bool})"/> </param>
        ...
        IConditionLocationTimeRealization Compute(IReadOnlyDictionary<IParameterEnum, ISample> sampleParameters, int id = -1);
        /// <summary>
        /// Generates a set of sampling probabilities for the specified set of <see cref="IConditionLocationTime{T}"/> parameters. 
        /// </summary>
        ...
        /// <param name="parameters"> A <see cref="IDictionary{TKey, TValue}"/> containing the <see cref="IConditionLocationTime{T}"/> parameters as <see cref="IParameterEnum"/> keys and a <see cref="bool"/> value: set to <see langword="true"/> if the parameter should be randomly sampled, <see langword="false"/> otherwise. <seealso cref="IConditionLocationTime{T}.Parameters"/> </param>
