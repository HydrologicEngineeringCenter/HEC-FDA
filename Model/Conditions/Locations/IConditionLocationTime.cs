...
namespace Model
{
    ...
    {        
        ...
        /// <param name="sampleParameters"> A <see cref="IDictionary{TKey, TValue}"/> containing the <see cref="IConditionLocationTime{T}"/> parameters as <see cref="IParameterEnum"/> keys and a <see cref="bool"/> value: set to <see langword="true"/> if the parameter should be randomly sampled, <see langword="false"/> otherwise. <seealso cref="IConditionLocationTime{T}.Parameters"/> </param>
