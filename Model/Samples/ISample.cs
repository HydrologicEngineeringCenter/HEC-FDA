...
{
    /// <summary>
    /// Provides a data interface for keeping track of sampled and constant parameters in complex functions, for instance <see cref="IConditionLocationYear.Compute()"/>
    /// </summary>
