        ...
        public class SimulationBuilder
        {
            ...
            public SimulationBuilder withStageDamages(List<UncertainPairedData> uncertainPairedDataList)
            {
                ...
                foreach (UncertainPairedData uncertainPairedData in _sim._damage_category_stage_damage)
                {
                    ...
                    _sim.AddSinglePropertyRule("positive-damage", new Rule(() => { return uncertainPairedData.Yvals[uncertainPairedData.Yvals.Length - 1].InverseCDF(0.5) > 0; }, "Stage-damage reflects 0 damage for highest stage", HEC.MVVMFramework.Base.Enumerations.ErrorLevel.Severe));
                }
                return new SimulationBuilder(_sim);
            }
